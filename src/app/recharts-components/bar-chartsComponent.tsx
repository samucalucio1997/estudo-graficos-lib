...
// Corrige a tipagem para aceitar strings e formatar a data corretamente
const monthTickFormatter = (tick: string): string => {
  const date = new Date(tick);
  return (date.getMonth() + 1).toString(); // Retorna o mês como string
};

// Corrige a tipagem e lógica do renderizador de ticks para o trimestre
const renderQuarterTick = (tickProps: TickProps) => {
  ...
  // Sempre retorna um ReactElement, nunca null
  if (month % 3 === 1) {
  ...
  return <></>; // Retorna um componente vazio, nunca null
};

export default class Example extends PureComponent {
  static demoUrl = 'https://codesandbox.io/p/sandbox/bar-chart-with-double-xaxis-zly7wl';

  // Adiciona a palavra-chave override para corrigir o aviso de tipagem
  override render() {
    return (
